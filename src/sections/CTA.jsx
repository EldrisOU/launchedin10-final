        ...
        <section id="cta" className="py-24 relative overflow-hidden bg-gradient-to-b from-primary to-[#0f172a]">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <a href="#pricing" className="group inline-flex items-center justify-center px-8 py-5 text-xl font-bold text-primary bg-white hover:bg-gray-50 transition-all shadow-luxury-elevated hover:shadow-luxury-glow min-w-[240px] rounded-none transform hover:-translate-y-1">
                        Start Your Build
